...
error_reporting(0);
   ...
   <a  href="my-account.php" title="My Account" itemprop="url">My Account</a>
                    ...
                    <div class="social1">
                               <span style="color:#fff;">Food Ordering System</span>
                    </div>
                </div>                
            </div><!-- Topbar -->
            <div class="logo-menu-sec">
                <div class="container">
                    <div class="logo"><h1 itemprop="headline"><a href="index.php" title="Home" itemprop="url">QuickBite</a></h1></div>
                    <nav>
                        <div class="menu-sec" style="margin-left: 100px;">
                            <ul>
