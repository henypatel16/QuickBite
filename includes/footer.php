  <footer>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6 col-lg-3">
                                        <div class="widget about_widget wow fadeIn" data-wow-delay="0.1s">
                                            <div class="logo"><h1 itemprop="headline"><a href="index.php" title="Home" itemprop="url" style="color:#fff">QuickBite</a></h1></div>
            ...
            <div class="container">
                 <p class="text-white text-center mt-3" itemprop="description">Copyright ©2024 All rights reserved &#10084; by <span style="color: #ff6600;">QuickBite</span></p>
            </div>
        </div><!-- Bottom Bar -->