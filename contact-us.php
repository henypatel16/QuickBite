...
<?php include_once('includes/header.php');?>
        <section>
            <div class="block">
				<div class="fixed-bg" style="background-image: url(assets/images/reservations.jpg);"></div>
  ...
  <div class="row justify-content-center">
    <div class="col-md-4 col-sm-6">
      <div class="contact-info-box">
        ...
        <h5>PHONE</h5>
        <p>+91 635-124-9014 | 125-668-886</p>
      </div>
    </div>
    <div class="col-md-4 col-sm-6">
      <div class="contact-info-box">
        ...
        <h5>ADDRESS</h5>
        <p>123 Middle Winchendon Rd, Food Street, Surat</p>
      </div>
    </div>
    <div class="col-md-4 col-sm-6">
      <div class="contact-info-box">
